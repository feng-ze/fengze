...
public class UserInfoService {
    ...
    public Message add(UserInfoDTO userInfoDto) {
        ...
        try {
            ...
            unite.setId(RandomUtil.randomUUID());
            unite.setUserId(user.getId());
    ...
    public Message delete(String worknumber) {
        ...
        Unite unite = uniteRepo.findAllByUserIdAndTreatId(userInfo.getId(), treatment.getId());
        if (!StringUtils.isEmpty(userInfo)) {
            userInfoRepo.delete(userInfo);
            if (!StringUtils.isEmpty(treatment)) {
                treatmentRepo.delete(treatment);
                if (!StringUtils.isEmpty(unite)){
